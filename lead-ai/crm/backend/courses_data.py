...
COURSE_NAME_MAP = {
    ...
    # ── Ad-name slug patterns (underscore/hyphen cleaned by _map_course) ──────
    'fellowship in emergency':                     'Fellowship in Emergency Medicine',
    'fellowship emergency medicine':               'Fellowship in Emergency Medicine',
    'fellowship critical care':                    'Fellowship in Critical Care',
    'fellowship internal medicine':                'Fellowship in Internal Medicine',
    'fellowship family medicine':                  'Fellowship in Family Medicine',
    'fellowship clinical cardiology':              'Fellowship in Clinical Cardiology',
    'fellowship echocardiography':                 'Fellowship in Echocardiography',
    'fellowship echo':                             'Fellowship in Echocardiography',
    '2d echo':                                     'Fellowship in Echocardiography',
    'fellowship interventional cardiology':        'Fellowship in Interventional Cardiology',
    'fellowship pediatric cardiology':             'Fellowship in Pediatric Cardiology',
    'paediatric cardiology':                       'Fellowship in Pediatric Cardiology',
    'fellowship cardiothoracic':                   'Fellowship in Cardiothoracic and Vascular Surgery',
    'cardiothoracic vascular surgery':             'Fellowship in Cardiothoracic and Vascular Surgery',
    'fellowship obstetrics gynecology':            'Fellowship in Obstetrics & Gynecology',
    'fellowship obg':                              'Fellowship in Obstetrics & Gynecology',
    'obg':                                         'Fellowship in Obstetrics & Gynecology',
    'obs gyne':                                    'Fellowship in Obstetrics & Gynecology',
    'fellowship fetal medicine':                   'Fellowship in Fetal Medicine',
    'fellowship fetal echocardiography':           'Fellowship in Fetal Echocardiography',
    'fetal echo':                                  'Fellowship in Fetal Echocardiography',
    'fellowship laparoscopy hysteroscopy':         'Fellowship in Laparoscopy & Hysteroscopy',
    'laparoscopy':                                 'Fellowship in Laparoscopy & Hysteroscopy',
    'hysteroscopy':                                'Fellowship in Laparoscopy & Hysteroscopy',
    'fellowship cosmetic gynecology':              'Fellowship in Cosmetic Gynecology',
    'fellowship gynaecological oncology':          'Fellowship in Gynaecological Oncology',
    'fellowship reproductive medicine':            'Fellowship in Reproductive Medicine',
    'fellowship embryology':                       'Fellowship in Embryology',
    'embryology':                                  'Fellowship in Embryology',
    'ivf':                                         'Fellowship in Reproductive Medicine',
    'fellowship diabetology':                      'Fellowship in Diabetology (Diabetes Mellitus)',
    'fellowship endocrinology':                    'Fellowship in Endocrinology',
    'fellowship gastroenterology':                 'Fellowship in Gastroenterology',
    'fellowship gi endoscopy':                     'Fellowship in GI Endoscopy',
    'fellowship dermatology':                      'Fellowship in Dermatology',
    'fellowship trichology':                       'Fellowship in Trichology',
    'trichology':                                  'Fellowship in Trichology',
    'fellowship cosmetology':                      'Fellowship in Cosmetology & Aesthetic Medicine',
    'fellowship general surgery':                  'Fellowship in General Surgery',
    'general surgery':                             'Fellowship in General Surgery',
    'fellowship minimal access surgery':           'Fellowship in Minimal Access Surgery',
    'mas':                                         'Fellowship in Minimal Access Surgery',
    'fellowship arthroscopy arthroplasty':         'Fellowship in Arthroscopy & Arthroplasty',
    'fellowship orthopedics':                      'Fellowship in Orthopedics',
    'ortho':                                       'Fellowship in Orthopedics',
    'fellowship spinal cord surgery':              'Fellowship in Spinal Cord Surgery',
    'spinal surgery':                              'Fellowship in Spinal Cord Surgery',
    'fellowship spine medicine':                   'Fellowship in Spine Medicine',
    'spine':                                       'Fellowship in Spine Medicine',
    'fellowship neurosurgery':                     'Fellowship in Neurosurgery',
    'neurosurgery':                                'Fellowship in Neurosurgery',
    'fellowship plastic surgery':                  'Fellowship in Plastic Surgery',
    'plastic surgery':                             'Fellowship in Plastic Surgery',
    'fellowship microsurgery':                     'Fellowship in Microsurgery',
    'fellowship vascular surgery':                 'Fellowship in Vascular Surgery',
    'vascular surgery':                            'Fellowship in Vascular Surgery',
    'fellowship paediatric surgery':               'Fellowship in Paediatric Surgery',
    'paediatric surgery':                          'Fellowship in Paediatric Surgery',
    'pediatric surgery':                           'Fellowship in Paediatric Surgery',
    'fellowship surgical oncology':                'Fellowship in Surgical Oncology',
    'fellowship medical oncology':                 'Fellowship in Medical Oncology',
    'fellowship head neck oncology':               'Fellowship in Head and Neck Oncology',
    'fellowship endocrine breast onco':            'Fellowship in Endocrine and Breast Onco Surgery',
    'fellowship oral oncology':                    'Fellowship in Oral Oncology',
    'oral oncology':                               'Fellowship in Oral Oncology',
    'fellowship pediatrics':                       'Fellowship in Pediatrics',
    'fellowship neonatology':                      'Fellowship in Neonatology',
    'fellowship pediatric neurology':              'Fellowship in Pediatric Neurology',
    'fellowship paediatric echocardiography':      'Fellowship in Paediatric Echocardiography',
    'fellowship neurology':                        'Fellowship in Neurology',
    'fellowship radiology':                        'Fellowship in Radiology',
    'fellowship neuroradiology':                   'Fellowship in Neuroradiology',
    'neuroradiology':                              'Fellowship in Neuroradiology',
    'fellowship interventional radiology':         'Fellowship in Interventional Radiology',
    'fellowship interventional neuroradiology':    'Fellowship in Interventional Neuroradiology',
    'fellowship musculoskeletal ultrasound':       'Fellowship in Musculoskeletal Ultrasound',
    'msk ultrasound':                              'Fellowship in Musculoskeletal Ultrasound',
    'fellowship vascular ultrasound':              'Fellowship in Vascular Ultrasound',
    'fellowship usg':                              'Fellowship in USG',
    'usg':                                         'Fellowship in USG',
    'fellowship pain management':                  'Fellowship in Pain Management',
    'fellowship interventional pain':              'Fellowship in Interventional Pain Management & Regional Anaesthesiology',
    'regional anaesthesiology':                    'Fellowship in Interventional Pain Management & Regional Anaesthesiology',
    'fellowship anesthesiology':                   'Fellowship in Anesthesiology',
    'anesthesiology':                              'Fellowship in Anesthesiology',
    'anaesthesiology':                             'Fellowship in Anesthesiology',
    'fellowship nephrology':                       'Fellowship in Nephrology',
    'fellowship urology':                          'Fellowship in Urology',
    'fellowship endourology':                      'Fellowship in Endourology',
    'endourology':                                 'Fellowship in Endourology',
    'fellowship pulmonary medicine':               'Fellowship in Pulmonary Medicine',
    'pulmonary':                                   'Fellowship in Pulmonary Medicine',
    'fellowship rheumatology':                     'Fellowship in Rheumatology',
    'fellowship psychiatry':                       'Fellowship in Psychiatry',
    'fellowship ophthalmology':                    'Fellowship in Ophthalmology',
    'fellowship oral implantology':                'Fellowship in Oral Implantology and Laser Dentistry',
    'oral implantology':                           'Fellowship in Oral Implantology and Laser Dentistry',
    'laser dentistry':                             'Fellowship in Oral Implantology and Laser Dentistry',
    'fellowship maxillofacial surgery':            'Fellowship in Maxillofacial Surgery',
    'maxillofacial':                               'Fellowship in Maxillofacial Surgery',
    'fellowship epidemiology':                     'Fellowship in Epidemiology',
    'fellowship sexology':                         'Fellowship in Sexology',
}
